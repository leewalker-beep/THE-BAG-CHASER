...
- Name: tests/progression.spec.ts >> Hustle Progression Verification >> Deep Dive r_labor Path 2: House Renovation -> Rent Portfolio
- Location: tests/progression.spec.ts:94:3
