...
export const GameProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if ((pl.bag || 0) < 0 && !fatalTragedyMessage) {
      setFatalTragedyMessage("BANKRUPTCY: Your cash reserves have dropped below zero. The banks have foreclosed on your soul. Game over.");
    }
  ...
  const adv = (months = 1) => {
    if (fatalTragedyMessage || pl.bag < 0) return;
  ...
  return (
    <GameContext.Provider value={{
      ...
      rTechSource, rTechFixA, rTechFixB, rRunnerRecruit, rRunnerFix, techSourceCost, cap
    }}>
      {children}
