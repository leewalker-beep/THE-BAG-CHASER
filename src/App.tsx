...
function App() {
  ...
  const [activeMiniGame, setActiveMiniGame] = useState<{ type: 'chart_match' | 'tap_mine' | 'tic_tac_toe' | 'scene_cut' | 'hype_meter' | 'rocket_launch' | 'grant_sort' | 'pattern_match' | 'rate_balance' | 'heirloom_catch', hustleId: string } | null>(null);
