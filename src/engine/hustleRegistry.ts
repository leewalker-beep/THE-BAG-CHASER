...
export const MASTER_HUSTLE_REGISTRY: HustleConfig[] = [
  ...
  { id: 'r_chill', tier: 'STREET', name: 'Vibe & Couch Gaming', description: 'Unplug from the hype cycle with your close day-ones to destress.', upfrontCost: 150, cloutReq: 0, yieldCash: 0, yieldClout: 5, yieldAura: 0, hitMental: 30, hitHeat: 0, fatigueCost: 0, successChance: 0.98, isPassive: false, icon: '🎮' },
  ...
  // --- TIER 1 ADDITIONS ---
  { id: 'r_pr_campaign', tier: 'STREET', name: 'Publicity PR Campaign', description: 'Hire a local street publicist to manufacture a curated clout stunt. Risky and expensive.', upfrontCost: 1500, cloutReq: 30, yieldCash: 0, yieldClout: 5, yieldAura: 25, hitMental: -10, hitHeat: 10, fatigueCost: 0, successChance: 0.80, isPassive: false, icon: '📣' },
