...
export const HUSTLE_PROGRESSIONS: Record<string, Record<string, HustleNode>> = {
  ...
  film_studio: {
    l1: { id: 'l1', name: 'Indie Film House', cost: 5000000, yieldCash: 2000000, yieldClout: 500, yieldAura: 300, successChance: 0.65, hitMental: -40, passiveMonthlyYield: 0, nextNodes: ['l2a', 'l2b'], cloutReq: 2500, auraReq: 1000 },
    l2a: { id: 'l2a', name: 'Blockbuster Production', cost: 15000000, yieldCash: 8000000, yieldClout: 2000, yieldAura: 1000, successChance: 0.6, hitMental: -50, passiveMonthlyYield: 0, nextNodes: ['l3a', 'l3b'] },
    l2b: { id: 'l2b', name: 'Film Equipment Rental', cost: 8000000, yieldCash: 0, yieldClout: 500, yieldAura: 200, successChance: 0.7, hitMental: -30, passiveMonthlyYield: 1500000, nextNodes: ['l3a'] },
    l3a: { id: 'l3a', name: 'Global Distribution Network', cost: 50000000, yieldCash: 30000000, yieldClout: 10000, yieldAura: 5000, successChance: 0.55, hitMental: -60, passiveMonthlyYield: 0, nextNodes: ['l4a'] },
    l3b: { id: 'l3b', name: 'Streaming Platform', cost: 40000000, yieldCash: 0, yieldClout: 8000, yieldAura: 3000, successChance: 0.65, hitMental: -45, passiveMonthlyYield: 10000000, nextNodes: ['l4a'] },
    l4a: { id: 'l4a', name: 'Hollywood Major Studio', cost: 250000000, yieldCash: 150000000, yieldClout: 50000, yieldAura: 25000, successChance: 0.5, hitMental: -80, passiveMonthlyYield: 0, nextNodes: [] },
  },
  fight_promoter: {
    l1: { id: 'l1', name: 'Underground Fight Club', cost: 1000000, yieldCash: 400000, yieldClout: 300, yieldAura: 200, successChance: 0.75, hitMental: -30, passiveMonthlyYield: 0, nextNodes: ['l2a', 'l2b'], cloutReq: 1500, auraReq: 500 },
    l2a: { id: 'l2a', name: 'Regional MMA Circuit', cost: 5000000, yieldCash: 2500000, yieldClout: 1500, yieldAura: 800, successChance: 0.7, hitMental: -40, passiveMonthlyYield: 0, nextNodes: ['l3a', 'l3b'] },
    l2b: { id: 'l2b', name: 'Fighter Management Agency', cost: 3000000, yieldCash: 0, yieldClout: 800, yieldAura: 500, successChance: 0.8, hitMental: -20, passiveMonthlyYield: 1000000, nextNodes: ['l3a'] },
    l3a: { id: 'l3a', name: 'National PPV Events', cost: 20000000, yieldCash: 15000000, yieldClout: 5000, yieldAura: 2000, successChance: 0.65, hitMental: -50, passiveMonthlyYield: 0, nextNodes: ['l4a'] },
    l3b: { id: 'l3b', name: 'Combat Sports Network', cost: 15000000, yieldCash: 0, yieldClout: 4000, yieldAura: 1500, successChance: 0.75, hitMental: -35, passiveMonthlyYield: 5000000, nextNodes: ['l4a'] },
    l4a: { id: 'l4a', name: 'Global Combat Syndicate', cost: 100000000, yieldCash: 75000000, yieldClout: 25000, yieldAura: 10000, successChance: 0.6, hitMental: -70, passiveMonthlyYield: 0, nextNodes: [] },
  },
  space_investment: {
    l1: { id: 'l1', name: 'Low Orbit Logistics', cost: 3000000, yieldCash: 1200000, yieldClout: 800, yieldAura: 500, successChance: 0.7, hitMental: -25, passiveMonthlyYield: 0, nextNodes: ['l2a', 'l2b'], cloutReq: 2000, auraReq: 800 },
    l2a: { id: 'l2a', name: 'Satellite Constellation', cost: 10000000, yieldCash: 6000000, yieldClout: 3000, yieldAura: 1500, successChance: 0.65, hitMental: -35, passiveMonthlyYield: 0, nextNodes: ['l3a', 'l3b'] },
    l2b: { id: 'l2b', name: 'Deep Space R&D', cost: 7000000, yieldCash: 0, yieldClout: 1500, yieldAura: 1000, successChance: 0.75, hitMental: -20, passiveMonthlyYield: 2500000, nextNodes: ['l3a'] },
    l3a: { id: 'l3a', name: 'Asteroid Mining Venture', cost: 50000000, yieldCash: 40000000, yieldClout: 10000, yieldAura: 5000, successChance: 0.55, hitMental: -50, passiveMonthlyYield: 0, nextNodes: ['l4a'] },
    l3b: { id: 'l3b', name: 'Off-World Data Centers', cost: 35000000, yieldCash: 0, yieldClout: 8000, yieldAura: 4000, successChance: 0.6, hitMental: -30, passiveMonthlyYield: 15000000, nextNodes: ['l4a'] },
    l4a: { id: 'l4a', name: 'Interstellar Monopoly', cost: 250000000, yieldCash: 200000000, yieldClout: 50000, yieldAura: 25000, successChance: 0.5, hitMental: -75, passiveMonthlyYield: 0, nextNodes: [] },
  },
  philanthropy_empire: {
    l1: { id: 'l1', name: 'Private Foundation', cost: 2000000, yieldCash: 0, yieldClout: 1500, yieldAura: 2500, successChance: 0.8, hitMental: -15, passiveMonthlyYield: 0, nextNodes: ['l2a', 'l2b'], cloutReq: 3000, auraReq: 1500 },
    l2a: { id: 'l2a', name: 'Global Relief Program', cost: 10000000, yieldCash: 0, yieldClout: 5000, yieldAura: 8000, successChance: 0.75, hitMental: -25, passiveMonthlyYield: 0, nextNodes: ['l3a', 'l3b'] },
    l2b: { id: 'l2b', name: 'Endowment Fund', cost: 8000000, yieldCash: 3000000, yieldClout: 2000, yieldAura: 3000, successChance: 0.85, hitMental: -10, passiveMonthlyYield: 4000000, nextNodes: ['l3a'] },
    l3a: { id: 'l3a', name: 'Supranational Policy Hub', cost: 50000000, yieldCash: 0, yieldClout: 25000, yieldAura: 40000, successChance: 0.7, hitMental: -40, passiveMonthlyYield: 0, nextNodes: ['l4a'] },
    l3b: { id: 'l3b', name: 'Technocratic Institute', cost: 35000000, yieldCash: 15000000, yieldClout: 10000, yieldAura: 15000, successChance: 0.75, hitMental: -20, passiveMonthlyYield: 20000000, nextNodes: ['l4a'] },
    l4a: { id: 'l4a', name: 'Civilization Architect', cost: 200000000, yieldCash: 0, yieldClout: 100000, yieldAura: 200000, successChance: 0.65, hitMental: -60, passiveMonthlyYield: 0, nextNodes: [] },
  },
  data_monopoly: {
    l1: { id: 'l1', name: 'Private Data Broker', cost: 4000000, yieldCash: 3000000, yieldClout: 2000, yieldAura: 1000, successChance: 0.65, hitMental: -35, passiveMonthlyYield: 0, nextNodes: ['l2a', 'l2b'], cloutReq: 4000, auraReq: 2000 },
    l2a: { id: 'l2a', name: 'Predictive Behavior Lab', cost: 12000000, yieldCash: 10000000, yieldClout: 6000, yieldAura: 3000, successChance: 0.6, hitMental: -45, passiveMonthlyYield: 0, nextNodes: ['l3a', 'l3b'] },
    l2b: { id: 'l2b', name: 'Data Pipeline API', cost: 9000000, yieldCash: 0, yieldClout: 3000, yieldAura: 1500, successChance: 0.7, hitMental: -25, passiveMonthlyYield: 5000000, nextNodes: ['l3a'] },
    l3a: { id: 'l3a', name: 'National Citizen Scoring', cost: 60000000, yieldCash: 50000000, yieldClout: 25000, yieldAura: 15000, successChance: 0.55, hitMental: -65, passiveMonthlyYield: 0, nextNodes: ['l4a'] },
    l3b: { id: 'l3b', name: 'Information Hegemony', cost: 45000000, yieldCash: 0, yieldClout: 15000, yieldAura: 10000, successChance: 0.6, hitMental: -40, passiveMonthlyYield: 25000000, nextNodes: ['l4a'] },
    l4a: { id: 'l4a', name: 'The Digital Panopticon', cost: 300000000, yieldCash: 250000000, yieldClout: 100000, yieldAura: 50000, successChance: 0.5, hitMental: -90, passiveMonthlyYield: 0, nextNodes: [] },
  },
  central_bank_play: {
    l1: { id: 'l1', name: 'Monetary Advisory', cost: 15000000, yieldCash: 10000000, yieldClout: 5000, yieldAura: 3000, successChance: 0.6, hitMental: -50, passiveMonthlyYield: 0, nextNodes: ['l2a', 'l2b'], cloutReq: 10000, auraReq: 5000 },
    l2a: { id: 'l2a', name: 'Currency Arbitrage', cost: 50000000, yieldCash: 40000000, yieldClout: 15000, yieldAura: 8000, successChance: 0.55, hitMental: -60, passiveMonthlyYield: 0, nextNodes: ['l3a', 'l3b'] },
    l2b: { id: 'l2b', name: 'Fiat Liquidity Provider', cost: 35000000, yieldCash: 0, yieldClout: 8000, yieldAura: 5000, successChance: 0.7, hitMental: -40, passiveMonthlyYield: 20000000, nextNodes: ['l3a'] },
    l3a: { id: 'l3a', name: 'Central Bank Digital Currency', cost: 200000000, yieldCash: 150000000, yieldClout: 50000, yieldAura: 25000, successChance: 0.5, hitMental: -80, passiveMonthlyYield: 0, nextNodes: ['l4a'] },
    l3b: { id: 'l3b', name: 'Global Reserve System', cost: 150000000, yieldCash: 0, yieldClout: 40000, yieldAura: 20000, successChance: 0.6, hitMental: -50, passiveMonthlyYield: 80000000, nextNodes: ['l4a'] },
    l4a: { id: 'l4a', name: 'Master of the Mint', cost: 750000000, yieldCash: 600000000, yieldClout: 200000, yieldAura: 100000, successChance: 0.45, hitMental: -100, passiveMonthlyYield: 0, nextNodes: [] },
  },
  legacy_fund: {
    l1: { id: 'l1', name: 'Multi-Generational Trust', cost: 10000000, yieldCash: 5000000, yieldClout: 4000, yieldAura: 2000, successChance: 0.7, hitMental: -30, passiveMonthlyYield: 0, nextNodes: ['l2a', 'l2b'], cloutReq: 8000, auraReq: 4000 },
    l2a: { id: 'l2a', name: 'Dynastic Real Estate', cost: 40000000, yieldCash: 25000000, yieldClout: 12000, yieldAura: 6000, successChance: 0.65, hitMental: -40, passiveMonthlyYield: 0, nextNodes: ['l3a', 'l3b'] },
    l2b: { id: 'l2b', name: 'Family Office', cost: 30000000, yieldCash: 0, yieldClout: 6000, yieldAura: 4000, successChance: 0.8, hitMental: -20, passiveMonthlyYield: 15000000, nextNodes: ['l3a'] },
    l3a: { id: 'l3a', name: 'Cultural Patrimony', cost: 150000000, yieldCash: 100000000, yieldClout: 40000, yieldAura: 20000, successChance: 0.6, hitMental: -50, passiveMonthlyYield: 0, nextNodes: ['l4a'] },
    l3b: { id: 'l3b', name: 'Sovereign Heritage Fund', cost: 120000000, yieldCash: 0, yieldClout: 30000, yieldAura: 15000, successChance: 0.7, hitMental: -30, passiveMonthlyYield: 60000000, nextNodes: ['l4a'] },
    l4a: { id: 'l4a', name: 'The Eternal Dynasty', cost: 500000000, yieldCash: 400000000, yieldClout: 150000, yieldAura: 75000, successChance: 0.55, hitMental: -70, passiveMonthlyYield: 0, nextNodes: [] },
  },
};
