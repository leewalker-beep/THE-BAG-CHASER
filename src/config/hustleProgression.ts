...
export const HUSTLE_PROGRESSIONS: Record<string, Record<string, HustleNode>> = {
  ...
  r_delivery: {
    ...
    l3a: { id: 'l3a', name: 'Logistics Hub', cost: 85000, yieldCash: 35000, yieldClout: 20, yieldAura: 0, successChance: 0.8, hitMental: -20, nextNodes: ['l4a'] },
    l3b: { id: 'l3b', name: 'Freight Brokerage', cost: 50000, yieldCash: 75000, yieldClout: 30, yieldAura: 0, successChance: 0.75, hitMental: -25, nextNodes: ['l4a'] },
