...
export const TIERS = [
  ...
  { id: 2, label: 'Corporate', req: { bag: 10000000,    clout: 300,  aura: 50  }, monthsRequired: 10, hustles: ['TECH', 'AI_AGENCY', 'CRE_FLIP', 'FRANCHISE'] },
  { id: 3, label: 'Elite',     req: { bag: 25000000,    clout: 500,  aura: 0   }, monthsRequired: 10, hustles: ['CRYP', 'TOUR', 'PE_ROLLUP', 'ART_SPEC'] },
